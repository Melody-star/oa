<template>
	...
	<view class="screen-box" v-show="isShowscreen">
		...
		<view class="screen-box-item" @click="choose(1)">
			<text class="screen-box-item-text">紧急</text>
		...
		<view class="screen-box-item" @click="choose(2)">
			<text class="screen-box-item-text">优先</text>
			<image v-show="nocompleteSelect" src="../../static/select.png" mode="" class="screen-box-item-icon">
			</image>
		</view>
		<view class="screen-box-item" @click="choose(3)">
			<text class="screen-box-item-text">常态</text>
			<image v-show="nullcompleteSelect" src="../../static/select.png" mode="" class="screen-box-item-icon">
			</image>
		</view>
	</view>
			...
			choose(value) {
				switch (value) {
					...
					case 1:
						...
						this.$emit('give-result', this.allList.filter(item => item.taskUrgentDegree == 0))
					...
					case 2:
						...
						this.$emit('give-result', this.allList.filter(item => item.taskUrgentDegree == 1))
					...
					case 3:
						...
						this.completeSelect = false
						this.nonecompleteSelect = false
						this.nullcompleteSelect = true

						this.$emit('give-result', this.allList.filter(item => item.taskUrgentDegree == 2))
